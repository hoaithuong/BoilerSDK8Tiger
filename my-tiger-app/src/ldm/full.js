...
/* THIS FILE WAS AUTO-GENERATED USING CATALOG EXPORTER; YOU SHOULD NOT EDIT THIS FILE; GENERATE TIME: 2020-06-30T07:32:12.175Z; */
...
export const Country = {
     ...
     * Display Form ID: countries.geo__country__location
     */
    Location: newAttribute("countries.geo__country__location"),
};
/**
...
export const State = {
    /**
     * Display Form Title: Location
     * Display Form ID: sightings.geo__state__location
     */
    Location: newAttribute("sightings.geo__state__location"),
    /**
     * Display Form Title: State
     * Display Form ID: sightings.state
     */
    Default: newAttribute("sightings.state"),
};
/**
